            ...
            <Tab.Container defaultActiveKey="tabBlock1" >
                ...
                <div className="hk-pg-header pg-header-wth-tab pt-7">
                    ...
                    <Nav variant="tabs" className="nav-line nav-light">
                        ...
                        <Nav.Item>
                            <Nav.Link eventKey="tabBlock6">
                                <span className="nav-link-text">Layout Settings</span>
                            </Nav.Link>
                        </Nav.Item>
                ...
                <div className="hk-pg-body">
                    <Tab.Content>
                        ...
                        <Tab.Pane eventKey="tabBlock6">
                            <Row>
                                <Col xl={8}>
                                    <div className="title-lg fs-5 mb-4">
                                        <span>Layout Settings</span>
                                    </div>
                                    <p className="mb-4">Choose your preferred layout style for the application. Changes will be applied immediately.</p>
                                    <LayoutSwitcher />
                                </Col>
                            </Row>
                        </Tab.Pane>
