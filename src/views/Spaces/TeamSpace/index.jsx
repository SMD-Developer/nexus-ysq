                    ...
                    <div className="d-flex align-items-start justify-content-between gap-3 flex-wrap">
                        <div className="team-space-title-wrap">
                            <div className="team-space-title-row">
                                ...
                                <Button variant="flush-dark" size="sm" className="btn-icon team-space-title-btn" aria-label="Favorite team space">
                                    <Star size={16} />
                                </Button>
                            </div>
                    ...
                    <Tab.Content>
                        <Tab.Pane eventKey="overview">
                            <Row className="g-3">
                                ...
                                <Col xl={4} lg={6}>
                                    <Card className="team-space-card team-space-card--fixed h-100">
                                        <Card.Header className="team-space-card-header">Docs</Card.Header>
                                        <Card.Body>
                                            <ListGroup variant="flush" className="team-space-list">
                                                <ListGroup.Item className="team-space-list-item">
